...
import './myclass.css';
import MyclassFunction from './f_myclass';
...
class MyClassPage extends React.Component {
    ...
    constructor() {
        super(undefined);
        this.function=new MyclassFunction();
                    ...
                    <div className='myclass_today'>
                        ...
                        <div className="myclass_today_content_form">
                            <div className="myclass_today_content">
                                <button className="myclass_detail_btn">
                                    <Link to='/myclassDetail'>
                                    <span>React를 이용한 To do list 만들기</span>
                                    </Link>
                                </button>
